...
replace (
	...
	github.com/pulumi/pulumi/pkg/v3 => github.com/pulumi/pulumi/pkg/v3 v3.81.0
)

require (
	github.com/jianyuan/terraform-provider-sentry v0.11.2
...
require (
	...
	github.com/jianyuan/go-sentry/v2 v2.2.0 // indirect
